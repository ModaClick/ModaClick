...
public class MedioPagoPorCompra {
    ...
    public boolean grabar(){
        String cadenaSQL= "insert into MedioPagoPorCompra(idMedioPagoCompra, idCompraDetalle, idPagos, fecha, valor) values ('" + idMedioPagoCompra + "','" + idCompraDetalle + "','" + idPagos + "','" + fecha + "','" + valor + "')";
