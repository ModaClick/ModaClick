...
<%
    List<String[]> datos = Venta.getTotalVentasPorMes(); // Método que obtiene los datos de ventas por mes
    String lista = "";
...
<div class="container-fluid">
    ...
    <h2>INDICADOR DE VENTAS POR MES</h2>
