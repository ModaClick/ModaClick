...
public String getMenu() {
    ...
    switch (this.codigo) {
        case "A":
            ...
            menu += "<li><a class='icon-category' href='principal.jsp?CONTENIDO=impuesto.jsp'>Impuestos</a></li>"; 
            menu += "<li><a class='icon-category' href='principal.jsp?CONTENIDO=mediosDePago.jsp'>Medios de Pago</a></li>";  
