...
<div class="form-container">
    ...
    <form name="formulario" method="post" action="principal.jsp?CONTENIDO=ventasActualizar.jsp">
        <table border="0">
            ...
            <tr>
                <th>Cliente</th>
                <td><input type="text" name="cliente" id="cliente" value="<%= venta.getIdCliente()%>" size="50"></td>
            </tr>
        </table>

        <input type="text" name="articulosVendidos" value="<%= lista%>" size="150">
        <table border="1" id="tablaArticulos">
            <tr>
                <th>Artículo</th><th>Valor unitario</th><th>Tipo tela</th><th>Color artículo</th><th>Talla</th><th>Impuestos</th><th>Cantidad</th><th></th><th>Subtotal</th>
                <th><img src="presentacion/adicionar.png" title="Adicionar" onclick="abrirFormulario();"></th>
            </tr>
            <%= lista%>
            <tr><th colspan="6">TOTAL</th><td align="right" id="totalVenta"><%= totalarticulos%></td></tr>
        </table>
    ...
    <div id="formulario" title="Adicionar artículo a la venta">
