...
<head>
    ...
    <style>
        ...
        video {
            ...
            width: auto;
            height: auto;
            z-index: -1; /* Enviar el video al fondo */
            transform: translate(-50%, -50%);
            opacity: 0.7; /* Aplica opacidad al video */
        }
        .login-container {
            min-height: 100vh;
            display: flex;
...
<body>
    ...
    <video autoplay muted loop>
        <source src="presentacion/videoalmacen2.mp4" type="video/mp4">
