...
public class CompraDetalle {
    ...
    private String costoUnitCompra; // Cambiado a costoUnitCompra
    ...
    public boolean grabar() {
        // Obtener el costoUnitCompra del artículo desde Inventario
        ...
        try {
            if (resultadoInventario.next()) {
                // Obtener el costo unitario de compra desde Inventario y asignarlo al campo costoUnitCompra
        ...
        // Luego, insertar el detalle de la compra en CompraDetalle con el costo unitario correcto
    ...
    // Método para modificar el detalle de la compra en la base de datos
    ...
    // Método para eliminar el detalle de la compra en la base de datos
    ...
    // Método para obtener una lista de detalles de compra desde la base de datos
    ...
    // Método para obtener una lista de detalles de compra como objetos
