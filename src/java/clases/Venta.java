...
public class Venta {
  ...
  public static ResultSet getLista(String filtro, String orden) {
        ...
        String cadenaSQL = "select idVenta, idCliente, fechaVenta, nombre, "
                + "getTotalVenta(idVenta) as Total, getAbonadoVenta(idVenta) as Abonado"
                + " from venta inner join Persona on identificacion=idCliente" + filtro + orden;
   ...
   public List<VentaDetalle> getDetalles() {
    ...
    public boolean eliminar() {
        String cadenaSQL = "DELETE FROM ventaDetalle WHERE idVentaDetalle = '" + idVenta + "'";
        System.out.println("Eliminando detalles de la venta: " + cadenaSQL);
        ConectorBD.ejecutarQuery(cadenaSQL);
        
        cadenaSQL = "DELETE FROM medioPagoPorVenta WHERE idVentaDetalle = '" + idVenta + "'";
        System.out.println("Eliminando medios de pago de la venta: " + cadenaSQL);
        ConectorBD.ejecutarQuery(cadenaSQL);
        
        cadenaSQL = "DELETE FROM venta WHERE idVenta = '" + idVenta + "'";
        System.out.println("Eliminando la venta: " + cadenaSQL);
        return ConectorBD.ejecutarQuery(cadenaSQL);
    }
