...
<%
    ...
    if ("Eliminar".equalsIgnoreCase(accion)) {
        ...
        String idVenta = request.getParameter("id").trim();
        if (idVenta != null && !idVenta.isEmpty()) {
            venta.setIdVenta(idVenta);
            boolean eliminado = venta.eliminar();

            if (!eliminado) {
                out.print("Error al eliminar la venta. Por favor, verifica el ID e intenta nuevamente.");
            } else {
                out.print("Venta eliminada correctamente.");
            }
        } else {
            out.print("El ID de la venta es inválido para la eliminación.");
        }
    }
%>
