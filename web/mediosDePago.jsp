...
<%
    ...
    for (MedioDePago medioPago : datos) {
        lista += "<tr>";
        ...
        lista += "<a href='javascript:void(0)' onclick='eliminar(" + medioPago.getId() + ")' title='Eliminar' class='btn btn-action btn-delete'><img src='presentacion/eliminar.png' class='icono' width='16'></a>";
        lista += "</td>";
        lista += "</tr>";
    }
%>
            ...
            <table class="table table-hover table-bordered">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th>Descripción</th>
                        <th>
                            <a href="principal.jsp?CONTENIDO=medioDePagoFormulario.jsp&accion=Adicionar" class="btn btn-action btn-add">
