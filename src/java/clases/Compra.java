...
public class Compra {
    ...
    public void setNombresProveedor(String nombresProveedor) {
        this.nombresProveedor = this.nombresProveedor;
    }
  ...
  public static ResultSet getLista(String filtro, String orden) {
        ...
        String cadenaSQL = "select idCompra, idProveedor, fechaCompra, nombre, "
                + "getTotalCompra(idCompra) as Total, getAbonadoCompra(idCompra) as Abonado"
                + " from compra inner join Persona on identificacion=idProveedor" + filtro + orden;
   ...
   public List<CompraDetalle> getDetalles() {
    ...
    public boolean eliminar() {
        String cadenaSQL = "DELETE FROM compraDetalle WHERE idCompraDetalle = '" + idCompra + "'";
        System.out.println("Eliminando detalles de la compra: " + cadenaSQL);
        ConectorBD.ejecutarQuery(cadenaSQL);
        
        cadenaSQL = "DELETE FROM medioPagoPorCompra WHERE idCompraDetalle = '" + idCompra + "'";
        System.out.println("Eliminando medios de pago de la compra: " + cadenaSQL);
        ConectorBD.ejecutarQuery(cadenaSQL);
        
        cadenaSQL = "DELETE FROM compra WHERE idCompra = '" + idCompra + "'";
        System.out.println("Eliminando la compra: " + cadenaSQL);
        return ConectorBD.ejecutarQuery(cadenaSQL);
    }
