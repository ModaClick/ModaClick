...
<body class="bg-light">
    <div class="container">
        <div class="table-container">
            <h3>DETALLES DE DEVOLUCION DE COMPRA</h3>

            <%
                String devolucionId = request.getParameter("id");
                DevolucionCompra devolucion = DevolucionCompra.getDevolucionPorId(Integer.parseInt(devolucionId));
                List<DevolucionDetallesCompra> detalles = DevolucionDetallesCompra.getDetallesPorDevolucion(devolucion.getId());
            %>

            <div class="info-section">
                <p><strong>Compra Nº:</strong> <%= devolucion.getCompra().getIdCompra() %></p>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <%
                            ...
                            for (DevolucionDetallesCompra detalle : detalles) {
                                ...
                                String consultaArticulo = "SELECT nombreArticulo FROM Inventario WHERE idArticulo = '" + compraDetalle.getIdArticuloInventario() + "'";
                        ...
                        <tr>
                            ...
                            <td><%= compraDetalle.getCantidad() %></td>
            ...
            <div class="button-section">
                <button onclick="window.location.href='principal.jsp?CONTENIDO=devolucion/DevolucionesCompras.jsp'">Regresar</button>
            </div>
        </div>
    </div>
</body>
