...
public class Pedido {
   ...
   public static ResultSet getLista(String filtro, String orden) {
    // Verificar y construir la cláusula WHERE si hay filtros
    ...
    // Verificar y construir la cláusula ORDER BY si hay orden
    ...
    // Consulta SQL con JOINs para obtener información adicional de Persona, TipoEnvio y Inventario
    String cadenaSQL = "SELECT Pedido.id, Pedido.idCliente, Persona.nombre AS nombreCliente, " +
                       "Pedido.idVentaDetalle, Pedido.fecha, Pedido.idTipoEnvio, TipoEnvio.nombre AS tipoEnvio, " +
                       "Pedido.estado, Inventario.nombreArticulo " +
                       "FROM Pedido " +
                       "JOIN Persona ON Pedido.idCliente = Persona.identificacion " +
                       "JOIN TipoEnvio ON Pedido.idTipoEnvio = TipoEnvio.id " +
                       "JOIN PedidoDetalle ON Pedido.id = PedidoDetalle.idPedido " + // Relación con PedidoDetalle
                       "JOIN Inventario ON PedidoDetalle.idArticulo = Inventario.idArticulo " + // Relación con Inventario
                       filtro + orden;
