...
public class MedioPagoPorVenta {
 ...
 public boolean grabar(){
    String cadenaSQL= "insert into MedioPagoPorVenta(idMedioPagoFactura,idVentaDetalle,idPagos, fecha,valor) values ('"+idMedioPagoFactura+"','"+idVentaDetalle+"','"+idPagos+"','"+ fecha + "','"+ valor+"')";
